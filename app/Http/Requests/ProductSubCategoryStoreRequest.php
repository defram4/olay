...
class ProductSubCategoryStoreRequest extends FormRequest
{
    ...
    {
        return [
            'category.product_category_id' => ['required', 'numeric'],
            'category.img' => ['required', 'file', 'max:2500'],
            'text.*.title' => ['required', 'string'],
            'text.*.sub_title' => ['required', 'string'],
            'text.*.text' => ['required', 'string'],
            'text.*.lang' => ['string'],
            'seoimg' => ['required', 'file', 'max:2500'],
    ...
    {
        return [
            'category.product_category_id' => trans('Category'),
            'category.img' => trans('Photo'),
