            ...
            <div class="row d-flex" style="justify-content: space-between;">
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title">Contact Us <button class="footer__widget--button"
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="index.html">
                                ...
                                <ul class="social__share footer__social d-flex">
                                    <li class="social__share--list">
                                        <a class="social__share--icon" target="_blank">
                                            <svg width="16" height="15" viewBox="0 0 9 15" fill="none"
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title">Help <button class="footer__widget--button"
                                aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
    ...
    <div class="footer__bottom">
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-center align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary">© 2023</span> Powered by <a
                        class="copyright__content--link" target="_blank"
                        href="{{ route('front.index', app()->getLocale()) }}">RoyalSystems</a></p>
            </div>
        </div>
    </div>
</footer>
