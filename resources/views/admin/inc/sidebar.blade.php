    ...
    <div class="sidebar-content">
        ...
        <div class="content-side content-side-full content-side-user px-10 align-parent">
            ...
            <div class="sidebar-mini-visible-b align-v animated fadeIn">
                <img class="img-avatar img-avatar32" src="{{ asset('/front//media/avatars/avatar15.jpg') }}" alt="">
            </div>
                ...
                @can('is-admin')
                    <li>
                        <a href="{{ route('admin.langs.index', ['locale' => app()->getLocale()]) }}"><i
                                ...
                                class="sidebar-mini-hide">{{ __('Languages') }}</span></a>
                    </li>
                    ...
                    {{--FAQ Terms Cookies--}}
                    <li class="{{ (request()->segment(3) == 'faq') || (request()->segment(3) == 'term') || (request()->segment(3) == 'policy') ? 'open' : '' }}">
                    ...
                    <li class="{{ (request()->segment(3) == 'contents') || (request()->segment(3) == 'images')  ? 'open' : '' }}">
