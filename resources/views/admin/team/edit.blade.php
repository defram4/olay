        ...
        <div class="col-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">{{ __('Edit team member') }}</h3>
                </div>
                ...
                <div class="block-content">
                    <form
                        action="{{ route('admin.teams.update', ['locale' => app()->getLocale(), 'team' => $team->id]) }}"
                        method="post"
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.name") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            <input type="text" class="form-control" id="name-{{ $loop->index }}"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $team->text[$loop->index]->name ?? '' }}">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.function") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            <input type="text" class="form-control" id="function-{{ $loop->index }}"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $team->text[$loop->index]->function ?? '' }}">
                                            <label for="title-{{ $loop->index }}">
                                                {{ __('Function') }}
                                                <span class="text-danger">*</span>
                                            </label>
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? "is-invalid" : "" }}">
                                        <div class="form-material floating">
                                            ...
                                            <textarea class="form-control js-summernote"
                                                      ...
                                                      name="text[{{ $loop->index }}][text]">{{ $team->text[$loop->index]->text ?? '' }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 {{ $errors->has('img') ? "is-invalid" : "" }}">
                                <img src="{{ asset('storage/team/'. $team->img) }}"
                                     class="img-fluid" alt="Team img">
