        ...
        <div class="col-12">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form action="{{ route('admin.newses.store', ['locale' => app()->getLocale()]) }}" method="post"
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.excerpt") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            <textarea type="text" class="form-control" id="excerpt-{{ $loop->index }}"
                                                name="text[{{ $loop->index }}][excerpt]" autocomplete="off">{{ old("text.$loop->index.excerpt") }}</textarea>
