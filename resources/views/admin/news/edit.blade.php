        ...
        <div class="col-12">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form action="{{ route('admin.newses.update', ['locale' => app()->getLocale(), 'news' => $news->id]) }}"
                            ...
                            @foreach ($langs as $lang)
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.excerpt") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            <textarea type="text" class="form-control" id="excerpt-{{ $loop->index }}"
                                                name="text[{{ $loop->index }}][excerpt]" autocomplete="off">{{ $news->text[$loop->index]->excerpt ?? '' }}</textarea>
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            ...
                                            <textarea class="form-control js-summernote" id="description-{{ $loop->index }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 {{ $errors->has('img') ? 'is-invalid' : '' }}">
                                <img src="{{ asset('storage/news/' . $news->img) }}" class="img-fluid" alt="news img">
                            ...
                            <div class="col-md-12 {{ $errors->has('seo.img') ? 'is-invalid' : '' }}">
                                <img src="{{ asset('storage/news/' . $news->meta->img) }}" class="img-fluid"
                                    alt="news CEO img">
                                <div class="form-material">
                                    <label for="seoimg">
                                        {{ __('Image SEO') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 {{ $errors->has('cover_img') ? 'is-invalid' : '' }}">
                                <img src="{{ asset('storage/news/' . $news->cover_img) }}" class="img-fluid"
                                    alt="news cover img">
                                <div class="form-material ">
                                    <label for="cover_img">
                                        {{ __('Cover Img') }}
