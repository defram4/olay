                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? "is-invalid" : "" }}">
                                        <div class="form-material floating">
                                            ...
                                            <textarea class="form-control js-summernote"
                                                      id="text-{{ $loop->index }}"
                                                      name="text[{{ $loop->index }}][text]">{{ $project->text[$loop->index]->text ?? '' }}</textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 {{ $errors->has('img') ? "is-invalid" : "" }}">
                                ...
                                <img src="{{ asset('storage/project/'. $project->img) }}"
                                     class="img-fluid" alt="project img">
                            ...
                            <div class="col-md-6 {{ $errors->has('seo.img') ? "is-invalid" : "" }}">
                                ...
                                <img src="{{ asset('storage/project/'. $project->meta->img) }}"
                                     class="img-fluid" alt="project img">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="form-material">
                                    ...
                                    <input type="file" class="form-control" id="img" name="gallery[]"
