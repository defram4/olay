                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 {{ $errors->has('big_video') ? "is-invalid" : "" }}">
                                <div class="form-material ">
                                    ...
                                    <video id="previewBigVideo" src="#" controls style="display: none;max-width: 400px"></video>
                                    <input type="file"
                                           class="form-control"
                                           id="big_video"
                                           name="big_video"
                            ...
                            <div class="col-md-6 {{ $errors->has('mobile_video') ? "is-invalid" : "" }}">
                                <div class="form-material ">
                                    ...
                                    <video id="previewMobileVideo" src="#" controls style="display: none;max-width: 400px"></video>
                                    <input type="file"
                                           class="form-control"
                                           id="mobile_video"
                                           name="mobile_video"
