                    ...
                    <form
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 {{ $errors->has('big_img') ? 'is-invalid' : '' }}">
                                @if ($banner->big_img)
                                    <img src="{{ asset('storage/banner/' . $banner->big_img) }}" class="img-fluid"
                                        alt="Banner big img">
                                @else
                            ...
                            <div class="col-md-6 {{ $errors->has('small_img') ? 'is-invalid' : '' }}">
                                @if ($banner->small_img)
                                    <img src="{{ asset('storage/banner/' . $banner->small_img) }}" class="img-fluid"
                                        alt="Banner small img">
                                @else
                                    <img class="img-fluid" width="160" height="90"
                                        src="{{ asset('admin/media/photos/no_img.jpg') }}" alt="banner img">
                                @endif
                            ...
                            {{-- <div class="col-md-6 {{ $errors->has('mobile_img') ? 'is-invalid' : '' }}">
                                @if ($banner->mobile_img)
                                    <img src="{{ asset('storage/banner/' . $banner->mobile_img) }}" class="img-fluid"
                            ...
                            <div class="col-md-6 {{ $errors->has('big_video') ? 'is-invalid' : '' }}">
                                ...
                                @else
                                    <img class="img-fluid" width="160" height="90"
                                        src="{{ asset('admin/media/photos/no_video.jpg') }}" alt="banner img">
                                @endif
                                <div class="form-material ">
                                    <label for="big_video">
                                        {{ __('Big Video') }}
