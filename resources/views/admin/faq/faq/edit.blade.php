        ...
        <div class="col-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">{{ __('Edit FAQ') }}</h3>
                </div>
                <div class="block-content">
                    <form
                        action="{{ route('admin.faqs.update', ['locale' => app()->getLocale(), 'faq' => $faq->id]) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.title") ? "is-invalid" : "" }}">
                                        <div class="form-material floating">
                                            <input type="text" class="form-control"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $faq->text[$loop->index]->title ?? '' }}">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? 'is-invalid' : '' }}">
                                        ...
                                        <textarea id="description-{{$loop->index}}" class="form-control js-summernote"
                                                  name="text[{{ $loop->index }}][text]">{{ $faq->text[$loop->index]->text ?? '' }}</textarea>
