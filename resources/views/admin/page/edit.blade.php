        ...
        <div class="col-12">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form
                        action="{{ route('admin.pages.update', ['locale' => app()->getLocale(), 'page' => $page->id]) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="{{ $errors->has("seotext.$loop->index.title") ? 'is-invalid' : '' }}">
                                        <div class="form-material floating">
                                            <input type="text"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $page->meta->text[$loop->index]->title ?? '' }}">
                                    ...
                                    <div
                                        ...
                                        <div class="form-material floating">
                                            <input type="text" class="form-control" id="keywords-{{ $loop->index }}"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $page->meta->text[$loop->index]->keywords ?? '' }}">
                                    ...
                                    <div class="{{ $errors->has("seotext.$loop->index.text") ? 'is-invalid' : '' }}">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  autocomplete="off">{{ $page->meta->text[$loop->index]->text ?? '' }}</textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-md-8 offset-2 {{ $errors->has('seoimg') ? 'is-invalid' : '' }}">
                                <img src="{{ storage('page', $page->meta->img ?? 'not img') }}" alt="page photo" class="img-fluid">
                                <div class="form-material">
                                    <label for="img">{{ __('image SEO') }}</label>
                                    <input type="file"
                                           class="form-control"
                                           id="img"
                                           name="seoimg"
