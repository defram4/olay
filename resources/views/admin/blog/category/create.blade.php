        ...
        <div class="col-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">{{ __('Add category') }}</h3>
                </div>
                <div class="block-content">
                    <form action="{{ route('admin.blog_categories.store', ['locale' => app()->getLocale()]) }}"
                          method="post"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.description") ? 'is-invalid' : ''}}">
                                        ...
                                        <textarea type="text"
                                                  ...
                                                  autocomplete="off">{{ old("text.$loop->index.description") }}</textarea>
