    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content tab-content">
                    ...
                    <div class="block">
                        <div class="col-sm-6 col-xl-4">
                            <a href="{{ route('admin.blog_categories.create', ['locale' => app()->getLocale()]) }}"
                                type="button" class="btn btn-alt-secondary min-width-125 js-click-ripple-enabled"
                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td style="width: 15%">
                                                <img class="img-fluid"
                                                    src="{{ asset('storage/category/' . $category->img) }}" alt="">
                                            </td>
                ...
                <div class="tab-pane {{ session('post_page') ? 'active' : '' }}" id="btabs-static-profile" role="tabpanel">
                    <div class="block">
                        <div class="col-sm-6 col-xl-4">
                                ...
                                <tbody>
                                    @foreach ($posts as $post)
                                        <tr>
                                            ...
                                            <td style="width: 15%">
                                                <img class="img-fluid" src="{{ asset('storage/post/' . $post->img) }}"
                                                    alt="">
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group">
