        ...
        <div class="col-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">{{ __('Add Terms & Conditions') }}</h3>
                </div>
                <div class="block-content">
                    <form action="{{ route('admin.terms.store', ['locale' => app()->getLocale()]) }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center my-3">
                                ...
                                <a href="{{ route('admin.terms.index', ['locale' => app()->getLocale()]) }}" type="submit"
