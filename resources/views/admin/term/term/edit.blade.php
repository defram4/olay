        ...
        <div class="col-12">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form
                        action="{{ route('admin.terms.update', ['locale' => app()->getLocale(), 'term' => $term->id]) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.title") ? "is-invalid" : "" }}">
                                        <div class="form-material floating">
                                            <input type="text" class="form-control"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $term->text[$loop->index]->title ?? '' }}">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? 'is-invalid' : '' }}">
                                        ...
                                        <textarea id="description-{{$loop->index}}" class="form-control js-summernote"
                                                  name="text[{{ $loop->index }}][text]">{{ $term->text[$loop->index]->text ?? '' }}</textarea>
