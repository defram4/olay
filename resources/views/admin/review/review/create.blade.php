        ...
        <div class="col-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">{{ __('Add Review') }}</h3>
                </div>
                <div class="block-content">
                    <form action="{{ route('admin.reviews.store', ['locale' => app()->getLocale()]) }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center my-3">
                                ...
                                <a href="{{ route('admin.reviews.index', ['locale' => app()->getLocale()]) }}" type="submit"
