        ...
        <div class="col-12">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form
                        action="{{ route('admin.reviews.update', ['locale' => app()->getLocale(), 'review' => $review->id]) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.title") ? "is-invalid" : "" }}">
                                        <div class="form-material floating">
                                            <input type="text" class="form-control"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ $review->text[$loop->index]->title ?? '' }}">
                                    ...
                                    <div class="{{ $errors->has("text.$loop->index.text") ? 'is-invalid' : '' }}">
                                        ...
                                        <textarea id="description-{{$loop->index}}" class="form-control js-summernote"
                                                  name="text[{{ $loop->index }}][text]">{{ $review->text[$loop->index]->text ?? '' }}</textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center my-3">
                                ...
                                <a href="{{ route('admin.reviews.index', ['locale' => app()->getLocale()]) }}"
                                   type="submit"
